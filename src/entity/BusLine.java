...
public class BusLine implements AutoIdIncreasable, Serializable {
    ...
    public void inputNewBusLine() {
        ...
        do {
            try {
                ...
                System.out.print("Khoảng cách của tuyến phải là số nguyên, yêu cầu nhập lại: ");
                continue;
            }
            if (distance > 0) {
        ...
        do {
            try {
                ...
                System.out.print("Số điểm dừng của tuyến phải là số nguyên, yêu cầu nhập lại: ");
                continue;
            }
